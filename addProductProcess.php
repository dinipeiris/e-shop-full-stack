...
if($category == "0"){
    ...
    (`user_email`, `price`,`qty`,`description`,`title`,`datetime_added`,`delivery_fee_colombo`,`delivery_fee_other`,`model_has_brand_id`,
    `category_id`,`color_id`,`condition_id`,`status_id`) VALUES 
    ('".$email."','".$cost."','".$qty."','".$desc."','".$title."','".$date."','".$dwc."','".$doc."',
    '".$model_has_brand_id."','".$category."','".$clr."','".$condition."','".$status."')");
