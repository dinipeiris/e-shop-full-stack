                    ...
                    <div class="row">
                        <div class="col-12 align-items-start bg-dark vh-100">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12 mt-5">
                                    <hr class="border border-1 border-white" />
                                    <a class="h4 text-white fw-bold" href="sellingHistory.php">Selling History</a>
                                    <hr class="border border-1 border-white" />
                                </div>
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                <div class="col-12 text-center">
                                    <label class="form-label fs-4 fw-bold text-decoration-underline">Most Sold Item</label>
                                </div>
                                <?php
