                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    for ($x = 0; $x < $cart_num; $x++) {
                                        ...
                                        $address_rs = Database::search("SELECT district.id AS d_id FROM `user_has_address` INNER JOIN `city` ON 
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <?php
                                                            $colour_rs = Database::search("SELECT `name` AS `cname` FROM `color` WHERE `id` = '".$product_data["color_id"]."'");
                                                            $colour_data = $colour_rs->fetch_assoc();

                                                            $condition_rs = Database::search("SELECT `name` AS `con_name` FROM `condition` WHERE `id` = '".$product_data["condition_id"]."'");
                                                            $condition_data = $condition_rs->fetch_assoc();
                                                        ?>

                                                        <span class="fw-bold text-black-50">Colour : <?php echo $colour_data["cname"] ?></span> &nbsp; |

                                                        &nbsp; <span class="fw-bold text-black-50">Condition : <?php echo $condition_data["con_name"] ?></span>
                                                        <br>
                                                        ...
                                                        <input type="number" class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" value="<?php echo $cart_data["qty"] ?>" min="1" max="<?php echo $product_data["qty"] ?>">
                                                        <br><br>
