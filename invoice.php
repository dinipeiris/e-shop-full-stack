    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 btn-toolbar justify-content-end">
                ...
                <button class="btn btn-danger me-2"><i class="bi bi-filetype-pdf" onclick="savePdf();"></i> Export as PDF</button>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 border-start border-5 border-primary mt-3 mb-3 rounded" style="background-color: #e7f2ff;">
                        <div class="row">
                            <div class="col-12 mt-3 mb-3">
                                ...
                                <label class="form-label fs-6">Purchased items can returned before 7 days of delivery.</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 text-center mb-3">
                        <label class="form-label fs-5 text-black-50 fw-bold">
                            Invoice was created on a computer and is valid without the signature and the seal.
                        </label>
                    </div>
