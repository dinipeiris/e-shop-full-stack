        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        <div class="col-2 col-lg-1 bg-secondary py-2 text-end">
                            <span class="fs-4 fw-bold"><?php echo $selected_data["id"]; ?></span>
                        </div>
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="pb<?php echo $selected_data['id']; ?>" class="btn btn-primary" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Unblock</button>
                            <?php
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <span class="fs-5"><?php echo $selected_data["price"]; ?></span><br />
