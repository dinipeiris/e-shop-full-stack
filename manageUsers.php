        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-success py-2">
                    ...
                    <div class="col-2 d-none d-lg-block bg-info py-2">
            ...
            ?>
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
                            <span class="fs-4" id="email"><?php echo $selected_data["email"]; ?></span>
                        </div>
                        <div class="col-2 d-none d-lg-block bg-info py-2">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="ub<?php echo $selected_data['email']; ?>" class="btn btn-primary" onclick="blockUser('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-9"> 
                                            <input type="text" class="form-control" aria-describedby="send_btn" id="msgtxt"/>
                                        </div>
                                        <div class="col-3 d-grid">
                                            <button type="button" class="btn btn-primary" id="send_btn" onclick="sendAdminMsg();">Send</button>
                                        </div>
                                    </div>
                                </div>
