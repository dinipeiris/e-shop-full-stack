                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-1 bg-light text-center">
                                <label class="form-label fs-6 py-5 fw-bold"><?php echo $invoice_data["id"]; ?></label>
                            </div>
                            <div class="col-12 col-lg-2 bg-light text-center">
                                <label class="form-label fs-5 py-5 px-3 fw-bold"><?php echo $invoice_data["date"]; ?></label>
                            </div>
                            <div class="col-12 col-lg-1 bg-light text-center">
                                <label class="form-label fs-4 py-5 fw-bold"><?php echo $invoice_data["qty"]; ?></label>
                            </div>
                            <div class="col-12 col-lg-2 bg-light text-center">
                                <label class="form-label fs-5 py-5 fw-bold">Rs. <?php echo $invoice_data["total"]; ?> .00</label>
                            </div>
                            <div class="col-12 col-lg-6 d-flex mx-auto bg-light">
                                    <div class="card mx-auto my-2" style="max-width: 560px;">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <?php
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><b><?php echo $seller_data["fname"] . " " . $seller_data["lname"]; ?></p>
                                                    <p class="card-text"><b>Rs. <?php echo $product_data["price"]; ?> .00</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6 d-grid">
                                        <button class="col-6 btn btn-secondary border border-1 fs-5 rounded mt-5 border-primary" onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>);">>
                                            <i class="bi bi-info-circle-fill"></i> Feedback
                                        </button>
                                    </div>
                                    <div class="col-6 d-grid d-md-flex justify-content-md-end">
                                        <button class="col-6 btn btn-danger fs-5 rounded mt-5">
                    ...
                    <div class="col-12 mb-3">
                        <div class="row">
                            <div class="offset-lg-10 col-12 col-lg-2 d-grid mb-3">
                                <button class="btn btn-success"><i class="bi bi-trash3-fill"></i> Delete All Records</button>
                            </div>
                        </div>
                    </div>
