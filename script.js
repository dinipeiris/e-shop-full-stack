...
function updateProfile(){
    ...
    if(image.files.length == 0){
        ...
        var confirmation = confirm("Are you sure that you don't want to update the profile image?");
...
function payNow(id){
    ...
    r.onreadystatechange = function(){
        ...
        if(r.readyState==4){
            ...
            var payment = {
                "sandbox": true,
                "merchant_id": "1221575",    // Replace your Merchant ID
                "return_url": "http://localhost/eShop/invoice.php?id=" + id,     // Important
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4){
            ...
            if(txt == "blocked"){
                ...
                document.getElementById("ub"+email).classList = "btn btn-primary";
