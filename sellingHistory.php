            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-1 bg-light text-end">
                        <label class="form-label fs-5 fw-bold">Invoice ID</label>
                    </div>
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-1 bg-light text-end">
                            <label class="form-label fs-5 fw-bold mt-1 mb-1"><?php echo $selected_data["id"]; ?></label>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="col-3 bg-light text-end">
                            <label class="form-label fs-5 fw-bold mt-1 mb-1">
                        ...
                        <div class="col-1 bg-light text-end">
                            <label class="form-label fs-5 fw-bold mt-1 mb-1"><?php echo $selected_data["qty"]; ?></label>
                        </div>
