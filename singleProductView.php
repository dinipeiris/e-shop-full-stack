...
if (isset($_GET["id"])) {
    ...
    product.model_has_brand_id,product.color_id,product.status_id,product.condition_id,product.user_email,
                            ...
                            <div class="col-lg-4 order-2 order-lg-1 d-none d-lg-block">
                                <div class="row">
                                    <div class="col-12 align-items-center border border-1 border-secondary">
                                        <div class="mainImg" id="main_img"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-2">
                            <div class="col-12">
                                <div class="row justify-content-center gap-2">
                                    ...
                                    <?php 
                                    $related_rs = Database::search("SELECT * FROM `product` WHERE `category_id` = '".$product_data["category_id"]."' AND `qty` > '0' AND `id` !='".$product_data["id"]."' LIMIT 2 OFFSET 5");
                                    ...
                                    ?>
                                        ...
                                        $related_img_rs = Database::search("SELECT * FROM `images` WHERE `product_id` = '".$related_data["id"]. "'");
                                        $related_img_data = $related_img_rs->fetch_assoc();
                                        
                                        ?>
                                            <img src="<?php echo $related_img_data["code"] ?>" class="img-fluid rounded-start" />
                                            <div class="card-body ms-0 m-0 text-center">
                                                ...
                                                <button class="col-12 btn btn-outline-light mt-2 border-info"><i class="bi bi-heart-fill text-danger fs-5"></i></button>
                                            </div>
                                        </div>
                                    <?php 
